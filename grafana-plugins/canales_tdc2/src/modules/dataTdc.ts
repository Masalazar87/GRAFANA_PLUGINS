...
let variableNombre1 = replaceVariables('$EQUIPO2');
tdc.DatosGenerales.Nombre = variableNombre1 !==''? variableNombre1: options.nombre;

if (variableNombre1 === 'PDU_DC_2A_1') {
    tdc.DatosGenerales.Nombre = "TDC-02A-1";
    tdc.Estado.Tablero2 = estadosStyles.deshabilitado;
    tdc.Estado.Tablero3 = estadosStyles.deshabilitado;
   }
if (variableNombre1 === 'PDU_DC_2A_2') {
    tdc.DatosGenerales.Nombre = "TDC-02A-2";
    tdc.Estado.Tablero1 = estadosStyles.deshabilitado;
    tdc.Estado.Tablero3 = estadosStyles.deshabilitado;
   }
if (variableNombre1 === 'PDU_DC_2A_3') {
    tdc.DatosGenerales.Nombre = "TDC-02A-3";
    tdc.Estado.Tablero1 = estadosStyles.deshabilitado;
    tdc.Estado.Tablero2 = estadosStyles.deshabilitado;
}
