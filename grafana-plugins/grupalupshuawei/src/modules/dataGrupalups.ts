...
const dataGrupalups = (data: PanelData, options: SimpleOptions): DataGrupalups => {  
   ...
   //grupalups.Parametros.Outcurr = Number.parseFloat(OUTPUT_CURRENT?.toFixed(2));
    ...
    //ESTADOS
    grupalups.Estados.Estado = POWER_ON_OFF ===1? estadoStyles.ok : estadoStyles.sinConexion;
    ...
    let Voltout = (OUTPUT_VOLTAGE + OUTPUT_VOLTAGE_2 + OUTPUT_VOLTAGE_3) /30;
    ...
    let Outpow = (OUTPUT_POWER + OUTPUT_POWER_2 + OUTPUT_POWER_3) / 10;
